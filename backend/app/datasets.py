...
PUBLIC_DATASET_SEEDS: tuple[dict[str, Any], ...] = (
    {
        'name': "Children's Dental Panoramic X-ray Dataset",
        'source_name': 'Kaggle / YOLOv8-C2f-CBAM GitHub',
        'homepage_url': 'https://www.kaggle.com/datasets/wanmugui/childrens-dental-panoramic-x-ray-dataset',
        'paper_url': 'https://github.com/yweian/YOLOv8-C2f-CBAM',
        'license': 'CC BY-NC 4.0 / source terms',
        'image_type': 'panoramic',
        'task_types': ['YOLO object detection', 'pediatric caries detection', 'disease classification'],
        'disease_tags': [
            'caries',
            'deep caries',
        ...
        'sample_size': '1164 children panoramic radiographs, 14 labeled classes',
        'annotation_format': 'YOLO labels',
        'access_status': 'open_reference',
        'priority': 'high',
        'notes': '本项目重点参考来源；适合验证 YOLOv8-C2f-CBAM 的儿童牙科全景片病灶检测与数据准备流程。',
    },
    {
