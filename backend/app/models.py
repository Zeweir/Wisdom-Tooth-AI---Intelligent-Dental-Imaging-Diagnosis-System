...
class ReportRecord(Base):
    ...
    pdf_variant: Mapped[str | None] = mapped_column(String(40), nullable=True)
    pdf_file_path: Mapped[str | None] = mapped_column(String(255), nullable=True)
    pdf_storage_provider: Mapped[str | None] = mapped_column(String(20), nullable=True)
    pdf_storage_bucket: Mapped[str | None] = mapped_column(String(100), nullable=True)
    pdf_storage_object_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
...
class UserRecord(Base):
    ...
    role: Mapped[str] = mapped_column(String(30), nullable=False, default='radiologist')
